...
- To ensure ergodicity + reversibility[^direction] [^reverse] we split the $x$ update into sequential (complementary) updates:
  ...
  2. Update **half** of $\textcolor{#AE81FF}{x}$:  
    [$\textcolor{#AE81FF}{x'} =$ [$x_{A}$]{.red-text}$\,+\,$[$m_{B}$]{.blue-text}$\,\odot\,$ [$\Lambda^{\pm}$]{.orange-text}$($[$x_{B}$]{.blue-text}$, \textcolor{#07B875}{v'})$]{style="font-size: 1.2em;"}

  3. Update (other) half of $\textcolor{#AE81FF}{x}$:  
    [$\textcolor{#AE81FF}{x''} =$ [$x'_{B}$]{.blue-text}$\,+\,$[$m_{A}$]{.red-text}$\,\odot\,$ [$\Lambda^{\pm}$]{.orange-text}$($[$x'_{A}$]{.red-text}$, \textcolor{#07B875}{v'})$]{style="font-size: 1.2em;"}
