...
# L2HMC: Generalizing the MD Update {.centeredslide}
...
::: {style="border-radius: 6px; padding:1%;"}
...
[$\hspace{0pt}\uparrow$]{.dim-text}  
[$\hspace{0pt}$ let's look at this]{.dim-text style="padding-top: 0.5em!important;"}
