...
[^resampled]: Resample both $v\sim \mathcal{N}(0, 1)$, and $d \sim \mathcal{U}(\pm)$ at the beginning of each trajectory
...
- This talk: [{{< fa brands github >}} `saforem2/lattice23`](https://github.com/saforem2/lattice23)
  - Slides: [📊 saforem2.github.io/lattice23](https://saforem2.github.io/lattice23)]
