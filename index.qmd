...
[[{{< fa brands github >}}](https://github.com/saforem2/lattice23) [`saforem2/lattice23`](https://saforem2.github.io/lattice23)]{style="font-size:0.8em;"}
...
4. [Extras](#sec-extras)
    ...
    <!-- - [HMC Update](#sec-hmcsu3) -->
    <!-- - [Networks](#sec-su3networks) -->
    <!-- - [Interpretation](#sec-interpretation) -->
    <!-- - [Next Steps](#sec-next-steps) -->
<!-- 4. [[Acknwowledgements](#sec-acknowledgements)]{style="font-size:1.1em;"} -->
...
::: {.callout title="L2HMC Update"}

- [Introduce $d \sim \mathcal{U}(\pm)$ to determine the direction[^resampled] of our update]{}
...
4. [$\textcolor{#07B875}{v''} =$ [$\Gamma^{\pm}$]{.pink-text}$(\textcolor{#AE81FF}{x''}, \textcolor{#07B875}{v'})$]{} [$\hspace{36pt}$ update $v$]{.dim-text style="font-size:0.9em;"}

:::

&nbsp;<br>  

[^resampled]: $d$ resampled at start of each trajectory, to ensure reversibility
...
[^half]: [To ensure ergodicity + reversibility[^direction] [^reverse], we split the [$x$]{.purple-text} update into sequential (complementary) updates:]{style="font-size:0.8em;"}
...
- [`input`[^sigma]: $\hspace{7pt}\left(U, F\right) \coloneqq (e^{i Q}, F)$]{style="border-bottom: 2px solid rgba(131, 131, 131, 0.493);"}
  $$\begin{align*}
...
::: {#fig-ridgeplot layout-ncol=3 layout-valign="top"}

![`100` train iters](./assets/SU3/logdet_ridgeplot1.svg){#fig-ridgeplot1 width="33%"}

![`500` train iters](./assets/SU3/logdet_ridgeplot2.svg){#fig-ridgeplot2 width="33%"}

![`1000` train iters](./assets/SU3/logdet_ridgeplot3.svg){#fig-ridgeplot3 width="33%"}

$\log|\mathcal{J}|$ vs. $N_{\mathrm{LF}}$ during training
:::
...
::: {layout-ncol=4 style="text-align:left;"}
...
## Links + References {#sec-references}
